...
export default function About() {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-20 pb-12 bg-[#8FBC8F] relative">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="bg-[#77995D] text-white rounded-full w-14 h-14 flex items-center justify-center mb-4 mx-auto">
                <Target className="h-6 w-6" />
              </div>
              <h3 className="text-2xl font-['Playfair_Display'] font-bold text-[#77995D] mb-4 text-center">Our Mission</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <h3 className="text-2xl font-['Playfair_Display'] font-bold text-[#77995D] mb-4 text-center">Our Vision</h3>
              <p className="text-gray-700 text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-[#77995D] mb-3">Excellence</h3>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-[#77995D] mb-3">Integrity</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-[#77995D] mb-3">Community</h3>
              <p className="text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="h-64 bg-gray-200 flex items-center justify-center">
                <div className="bg-[#77995D] text-white text-3xl font-bold rounded-full w-24 h-24 flex items-center justify-center">
                  JP
                </div>
              </div>
              <div className="p-6 text-center">
                <h3 className="text-xl font-bold text-[#77995D] mb-1">John Patrice, M.Ed</h3>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                <h3 className="text-xl font-bold text-[#77995D] mb-1">Mary Omweri, BSc</h3>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                <h3 className="text-xl font-bold text-[#77995D] mb-1">Samuel Omwenga, MA</h3>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-['Playfair_Display'] font-bold text-[#77995D] mb-4">Academic Excellence</h3>
            ...
            <div>
              <h3 className="text-2xl font-['Playfair_Display'] font-bold text-[#77995D] mb-4">Co-Curricular Excellence</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  <div className="bg-[#ffc857] rounded-full w-5 h-5 mt-1 mr-3"></div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-[#77995D] mb-2">Modern Classrooms</h3>
                <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-[#77995D] mb-2">Science Laboratories</h3>
                <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-[#77995D] mb-2">Sports Facilities</h3>
                <p className="text-gray-700 mb-4">
          ...
          <div className="text-center">
            <Button 
              variant="default" 
              className="bg-[#77995D] hover:bg-[#A0C29A] text-white transition duration-300 transform hover:-translate-y-1 hover:shadow-md"
              asChild
            >
              <Link href="/campuses">
      ...
      {/* Call To Action */}
      <section className="py-16 bg-[#8FBC8F]">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Button 
              variant="default" 
              className="bg-[#ffc857] hover:bg-[#ffe09a] text-[#77995D] font-bold"
              asChild
            >
            ...
            <Button 
              variant="outline" 
              className="border-white text-white hover:bg-white hover:text-[#77995D]"
              asChild
            >
